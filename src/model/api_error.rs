...
impl APIError {
    pub fn new(error_type: APIErrorTypes, error_message: String, file: String, method:String, error_datestamp: DateTime<Utc>, error_info: String, error_code: APIErrorCodes) -> APIError{
        APIError {error_type, error_message, file, method, error_datestamp, error_info, error_code}
    }
 }
